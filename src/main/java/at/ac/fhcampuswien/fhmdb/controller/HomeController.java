...
public class HomeController implements Initializable {
    ...
    private final ClickEventHandler<Movie> onAddToWatchlistClicked = movie -> {
        try {
            watchlistRepo.add(movie.getId());
            new UserDialog("Erfolg", "'" + movie.getTitle() + "' wurde zur Watchlist hinzugefügt").show();
        } catch (DatabaseException e) {
            new UserDialog("Datenbankfehler", "Konnte Film nicht zur Watchlist hinzufügen").show();
        }
    };
